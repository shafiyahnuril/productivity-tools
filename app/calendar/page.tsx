...
import { Search, Plus, MoreHorizontal, Clock, BookOpen, Briefcase } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-1 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-2 gap-4">
             <Card>
               <div className="text-xs font-semibold mb-4 text-center">Statistik Jadwal Minggu Ini</div>
             ...
             <Card className="flex flex-col">
               <div className="text-xs font-semibold mb-4 text-center">Jadwal vs. Selesai</div>
