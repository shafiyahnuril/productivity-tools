...
export function Input({
  ...
  return (
    <input
      className={`bg-surface-tertiary border border-border rounded-md px-4 py-2 text-sm placeholder:text-foreground-tertiary focus:outline-none focus:border-primary transition-all duration-200 ${className}`}
      style={{
        boxShadow: 'none',
